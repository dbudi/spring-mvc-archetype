...
import com.github.springmvc.common.CrudController;
import com.github.springmvc.form.MenuForm;
import com.github.springmvc.form.RoleForm;
...
import com.github.springmvc.service.MenuService;
import com.github.springmvc.support.web.Ajax;
import com.github.springmvc.support.web.MessageHelper;
...
public class RoleController extends CrudController<RoleForm, Role> {
	...
	public String menu(Model model, @RequestParam(value = "roleId", required = true) String roleId, 
		...
		List<String> checkedMenuCodeList = new ArrayList<String>();
